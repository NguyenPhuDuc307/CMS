...
namespace CMS.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(IRoleRepository roleRepository, IPermissionRepository permissionRepository, IFunctionRepository functionRepository)
        {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var viewModel = new EditRoleViewModel
            {
                ...
                Permissions = commandInFunction.Select(p => new PermissionViewModel
                {
                    ...
                    IsAssigned = assignedPermissionSet.Contains($"{p.FunctionId} - {p.CommandId}"),
