...
namespace CMS.Services
{
    ...
    {
        private readonly GoogleCloudStorageSettings _options;
        private readonly ILogger<CloudStorageService> _logger;
        private readonly GoogleCredential _googleCredential;

        public CloudStorageService(IOptions<GoogleCloudStorageSettings> options, ILogger<CloudStorageService> logger)
        {
